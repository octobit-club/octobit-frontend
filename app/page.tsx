...
import { Users, Calendar, ArrowRight, AlertCircle, X, MapPin, Clock, Star } from "lucide-react";
...
export default function HomePage() {
  // Next event data - this would come from your backend/API in production
  const nextEvent = {
    id: 1,
    ...
    date: new Date("2025-10-15T14:00:00"), // October 15, 2025 at 2:00 PM
  ...
  // Get announcements and show the most important one
  const allAnnouncements = getAllAnnouncements();
  const importantAnnouncement = allAnnouncements
  ...
  const handleEventSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log('Event registration data:', eventFormData);
    setIsSubmitted(true);

...
export default function ChefNewTaskPage() {
  const router = useRouter()
  const users: import("@/lib/auth").User[] = getAllUsers()
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push("/chef-departement/tasks")
  }

  const departmentMembers = users.filter((u) => u.department === user.department && u.role === "membre")
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-yellow-50 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl text-purple-900">Créer une Nouvelle Tâche - {user.department}</CardTitle>
          </CardHeader>
          <CardContent>
